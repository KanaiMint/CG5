Shader "Unlit/04_Phong"
{
   Properties{
    ...
    rim_Color("Rim_Color",Color) = (1,0,0,1)
    rim_LineColor("Rim_LineColor",Color) = (1,0,0,1)
        ...
        Pass
        {
           ...
           sampler2D _MainTex;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                //リムライト
                fixed4 rim = pow((dot(i.normal,-eyeDir)+1.0f),1.0f);
                fixed4 rimLine = rim_LineColor*step(0.8f,rim);
                return rimLine+step(rimLine.a,phong)*(phong+rim*rim_Color);
